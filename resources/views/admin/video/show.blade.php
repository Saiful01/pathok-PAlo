    ...
    <div class="block block-rounded">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">
                Video <small>Table</small>


                <a href="/videos/create" class="btn btn-alt-primary float-end">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons dataTable no-footer"
                    ...
                    @foreach($result as $item)
                        <tr>
                            ...
                            <td class="font-w600"><a target="_blank" href="https://www.youtube.com/watch?v={{$item->link}}">Link </a> </td>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('videos.edit', $item ) }}" method="POST">
                                        @csrf
                                        @method("GET")
