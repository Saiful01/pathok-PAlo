    ...
    <div class="block block-rounded">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">
                ...
                <a href="/galleries/create" class="btn btn-alt-primary float-end">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons dataTable no-footer"
                    ...
                    @foreach($result as $item)
                        <tr>
                            ...
                            <td class="font-w600"><img src="{{$item->featured_image}}" style="width: 100px"/> </td>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('galleries.edit', $item ) }}" method="POST">
                                        @csrf
                                        @method("GET")
